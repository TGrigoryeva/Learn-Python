...
when_next_full_moon_question = "Когда ближайшее полнолуние после 2016-10-01"
...
next_full_moon_date = datetime.strptime(find_date_in_next_full_moon_question_String, "%Y/%m/%d")
